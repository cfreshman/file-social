...
DEPLOY_USER="root"                    # SSH user (use root for VPS, pi for Raspberry Pi)
DEPLOY_HOST="1.2.3.4"                 # Server IP address or hostname
...
# For custom SSH ports: ssh-copy-id -p PORT user@host
